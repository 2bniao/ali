...
public class T3 {
    public static void main(String[] args) {
        ...
        try {
            ...
            /*
             * Element elLev = el1.select("td").get(5); Element elScore = el1.select("td").get(4); Element el2 =
             * el1.select("tbody.table-player-detail").first(); Element elName = el2.select("td").first(); Element
             * elNumber = el2.select("td").get(1); Element elDetail = elName.select("a[href]").first(); Element elPic =
             * elDetail.select("img").first(); System.out.println(elPic.attr("src"));
             * System.out.println(elDetail.attr("href")); System.out.println(elName.text());
             * System.out.println(elNumber.text()); System.out.println(elLev.text());
             * System.out.println(elScore.text()); System.out.println("===");
             */
        } catch (IOException e) {
